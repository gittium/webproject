...
if(isset($_POST['update_product'])){
   ...
   if(empty($product_name) || empty($product_price)  || empty($product_description) || empty($product_image)||empty($product_stock)){
      $message[] = 'please fill out all!';    
   }else{

      $update_data = "UPDATE products SET name='$product_name', description = '$product_description', price='$product_price', stock = '$product_stock', image='$product_image'  WHERE product_id = '$id'";
...
<div class="admin-product-form-container centered">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" min="0" class="box" name="product_stock" value="<?php echo $row['price']; ?>" placeholder="enter the product price">
